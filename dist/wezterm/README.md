...
| Paris Guimard | [`paris-guimard.toml`](paris-guimard.toml) | `~/.config/wezterm/colors/paris-guimard.toml` |
| Paris Catacombes | [`paris-catacombes.toml`](paris-catacombes.toml) | `~/.config/wezterm/colors/paris-catacombes.toml` |
| Paris Carrelage | [`paris-carrelage.toml`](paris-carrelage.toml) | `~/.config/wezterm/colors/paris-carrelage.toml` |
...
**Paris Guimard**, in ~/.config/wezterm/wezterm.lua:
...
**Paris Catacombes**, in ~/.config/wezterm/wezterm.lua:
...
**Paris Carrelage**, in ~/.config/wezterm/wezterm.lua:
...
- Delete `~/.config/wezterm/colors/paris-guimard.toml`.
- Delete `~/.config/wezterm/colors/paris-catacombes.toml`.
- Delete `~/.config/wezterm/colors/paris-carrelage.toml`.
