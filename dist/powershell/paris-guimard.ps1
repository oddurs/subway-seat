...
& {
    ...
    $colors = @{
        Default                = "${esc}[38;2;211;226;219m"                  # text
        ...
        Member                 = "${esc}[38;2;187;205;197m"                  # subtext1
        Number                 = "${esc}[38;2;239;121;111m"                  # red_hi
        Type                   = "${esc}[38;2;111;179;147m"                  # sage
        Keyword                = "${esc}[38;2;215;142;60m"                   # orange
        Comment                = "${esc}[3;38;2;103;137;122m"                # overlay1, italic
        Error                  = "${esc}[38;2;239;121;111m"                  # red_hi
        Emphasis               = "${esc}[1;38;2;235;195;66m"                 # yellow, bold: search matches
        Selection              = "${esc}[1;38;2;230;240;235;48;2;40;90;71m"  # text_hi on the selection ground
        ContinuationPrompt     = "${esc}[38;2;103;137;122m"                  # overlay1
        InlinePrediction       = "${esc}[38;2;71;112;95m"                    # overlay0, like fish autosuggestions
        ListPrediction         = "${esc}[38;2;215;142;60m"                   # orange: the > marker and source
        ListPredictionSelected = "${esc}[48;2;25;74;57m"                     # surface1 ground
        ListPredictionTooltip  = "${esc}[3;38;2;103;137;122m"                # overlay1, italic
    }
    ...
    if ($PSStyle) {
        $formatting = @{
            ...
            FeedbackText           = "${esc}[38;2;187;205;197m"
