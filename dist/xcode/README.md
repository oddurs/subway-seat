...
Source editor, console and rendered documentation colours in SF Mono, with comments in italic. Change the font size in Xcode's Themes settings; the colours stay.

[Xcode](https://developer.apple.com/xcode/) · [All ports and previews](https://oddurs.github.io/subway-seat/ports/xcode/)
