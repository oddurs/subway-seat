...
# General
ZSH_HIGHLIGHT_STYLES[default]='fg=#D3E2DB'
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#EF796F'
ZSH_HIGHLIGHT_STYLES[comment]='fg=#67897A,italic'
...
ZSH_HIGHLIGHT_STYLES[assign]='fg=#D3E2DB'
ZSH_HIGHLIGHT_STYLES[path]='fg=#BBCDC5,underline'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#86A195,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#BBCDC5,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#86A195,underline'
...
ZSH_HIGHLIGHT_STYLES[cursor]='fg=#0A1D15,bg=#EBC342'

# zsh-autosuggestions (fish's autosuggestion color)
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=#67897A'
