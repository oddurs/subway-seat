...
style.error                    = { common.color "#FF8373" }
...
style.syntax["comment"]  = { common.color "#917759" }
style.syntax["keyword"]  = { common.color "#EC7F31" }
style.syntax["keyword2"] = { common.color "#86AD95" }
style.syntax["number"]   = { common.color "#FF8373" }
style.syntax["literal"]  = { common.color "#FF8373" }
style.syntax["string"]   = { common.color "#ADB956" }
style.syntax["operator"] = { common.color "#AA9171" }
