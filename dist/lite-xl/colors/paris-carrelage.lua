...
style.caret                    = { common.color "#8A5308" }
style.accent                   = { common.color "#8A5308" }
...
style.line_number2             = { common.color "#8A5308" }
...
style.drag_overlay_tab         = { common.color "#8A5308" }
...
style.bracketmatch_color       = { common.color "#8A5308" }
style.bracketmatch_char_color  = { common.color "#8A5308" }
...
style.syntax["keyword"]  = { common.color "#8A5308" }
style.syntax["keyword2"] = { common.color "#0B714D" }
