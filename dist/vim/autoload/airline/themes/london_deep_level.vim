...
if &background ==# 'light'
  ...
  let g:airline#themes#london_deep_level#palette.normal = airline#themes#generate_color_map(['#E8F0FF', '#B14A07', 255, 130, 'bold'], ['#3C4557', '#A8BBE2', 238, 146], ['#4A5469', '#DCE5F7', 240, 254])
  let g:airline#themes#london_deep_level#palette.normal.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.normal.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
  ...
  let g:airline#themes#london_deep_level#palette.insert.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.insert.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
  let g:airline#themes#london_deep_level#palette.visual = airline#themes#generate_color_map(['#E8F0FF', '#896800', 255, 94, 'bold'], ['#3C4557', '#A8BBE2', 238, 146], ['#4A5469', '#DCE5F7', 240, 254])
  let g:airline#themes#london_deep_level#palette.visual.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.visual.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
  let g:airline#themes#london_deep_level#palette.replace = airline#themes#generate_color_map(['#E8F0FF', '#C92B23', 255, 160, 'bold'], ['#3C4557', '#A8BBE2', 238, 146], ['#4A5469', '#DCE5F7', 240, 254])
  let g:airline#themes#london_deep_level#palette.replace.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.replace.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
  ...
  let g:airline#themes#london_deep_level#palette.commandline.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.commandline.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
  let g:airline#themes#london_deep_level#palette.terminal = airline#themes#generate_color_map(['#E8F0FF', '#7660AB', 255, 97, 'bold'], ['#3C4557', '#A8BBE2', 238, 146], ['#4A5469', '#DCE5F7', 240, 254])
  let g:airline#themes#london_deep_level#palette.terminal.airline_warning = ['#E8F0FF', '#896800', 255, 94]
  let g:airline#themes#london_deep_level#palette.terminal.airline_error = ['#E8F0FF', '#C92B23', 255, 160]
