...
if &background ==# 'light'
  ...
  let g:airline#themes#paris_guimard#palette.normal = airline#themes#generate_color_map(['#E4EDE8', '#754500', 255, 94, 'bold'], ['#374940', '#A3BFB0', 238, 249], ['#45594F', '#D8E3DC', 240, 254])
  ...
  let g:airline#themes#paris_guimard#palette.insert = airline#themes#generate_color_map(['#E4EDE8', '#207F41', 255, 29, 'bold'], ['#374940', '#A3BFB0', 238, 249], ['#45594F', '#D8E3DC', 240, 254])
  ...
  let g:airline#themes#paris_guimard#palette.commandline = airline#themes#generate_color_map(['#E4EDE8', '#086142', 255, 23, 'bold'], ['#374940', '#A3BFB0', 238, 249], ['#45594F', '#D8E3DC', 240, 254])
  ...
  let g:airline#themes#paris_guimard#palette.normal.airline_warning = ['#131A17', '#EBC168', 234, 179]
  ...
  let g:airline#themes#paris_guimard#palette.insert.airline_warning = ['#131A17', '#EBC168', 234, 179]
  let g:airline#themes#paris_guimard#palette.insert.airline_error = ['#131A17', '#E1837A', 234, 174]
  let g:airline#themes#paris_guimard#palette.visual = airline#themes#generate_color_map(['#131A17', '#EBC168', 234, 179, 'bold'], ['#C2CBC5', '#30463B', 251, 238], ['#A9B5AE', '#18241D', 249, 234])
  let g:airline#themes#paris_guimard#palette.visual.airline_warning = ['#131A17', '#EBC168', 234, 179]
  ...
  let g:airline#themes#paris_guimard#palette.replace.airline_warning = ['#131A17', '#EBC168', 234, 179]
  ...
  let g:airline#themes#paris_guimard#palette.commandline.airline_warning = ['#131A17', '#EBC168', 234, 179]
  ...
  let g:airline#themes#paris_guimard#palette.terminal.airline_warning = ['#131A17', '#EBC168', 234, 179]
