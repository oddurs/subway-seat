...
if &background ==# 'light'
  ...
  let g:airline#themes#subway_seat_tunnel#palette.terminal = airline#themes#generate_color_map(['#F4E9D4', '#863913', 255, 88, 'bold'], ['#54402F', '#CAB48E', 238, 180], ['#654F3B', '#EBDEC6', 240, 187])
