...
if &background ==# 'light'
  ...
  let g:airline#themes#subway_seat#palette.normal = airline#themes#generate_color_map(['#F8EFDF', '#AD4E00', 255, 130, 'bold'], ['#54402F', '#CBB898', 238, 180], ['#654F3B', '#EEE4D0', 240, 254])
  let g:airline#themes#subway_seat#palette.normal.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.normal.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
  ...
  let g:airline#themes#subway_seat#palette.insert.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.insert.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
  let g:airline#themes#subway_seat#palette.visual = airline#themes#generate_color_map(['#F8EFDF', '#936200', 255, 94, 'bold'], ['#54402F', '#CBB898', 238, 180], ['#654F3B', '#EEE4D0', 240, 254])
  let g:airline#themes#subway_seat#palette.visual.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.visual.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
  let g:airline#themes#subway_seat#palette.replace = airline#themes#generate_color_map(['#F8EFDF', '#BC4031', 255, 124, 'bold'], ['#54402F', '#CBB898', 238, 180], ['#654F3B', '#EEE4D0', 240, 254])
  let g:airline#themes#subway_seat#palette.replace.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.replace.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
  ...
  let g:airline#themes#subway_seat#palette.commandline.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.commandline.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
  let g:airline#themes#subway_seat#palette.terminal = airline#themes#generate_color_map(['#F8EFDF', '#863913', 255, 88, 'bold'], ['#54402F', '#CBB898', 238, 180], ['#654F3B', '#EEE4D0', 240, 254])
  let g:airline#themes#subway_seat#palette.terminal.airline_warning = ['#F8EFDF', '#936200', 255, 94]
  let g:airline#themes#subway_seat#palette.terminal.airline_error = ['#F8EFDF', '#BC4031', 255, 124]
