...
class SubwaySeatEnamelStyle(Style):
    ...
    styles = {
        ...
        Token.Comment.Preproc: "italic #863913",
        ...
        Token.Literal.String.Escape: "#863913",
        Token.Literal.String.Interpol: "#863913",
        Token.Literal.String.Regex: "#863913",
