...
META = {
    ...
    "notes": "Prompt, reply, tool and completion-menu colors for aider's config file. Code blocks use "
...
# (without it, use ansi_dark / ansi_light to take your terminal's colors)
code-theme: {f.slug}
"""
