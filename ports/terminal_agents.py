...
the terminal's 16 colours. The files are the settings that make them do so."""
...
META = {
    ...
    "enable": {
        ...
        "code": "/settings theme default   # GitHub Copilot CLI (Base-16 terminal colours)\n"
        "/t ansi                   # Goose (saved as GOOSE_CLI_THEME)\n"
        "# Amp: nothing to set",
        "lang": "text",
    },
    "notes": "These agents have no theme files; they use your terminal's colours, so a Subway Seat "
...
def build(flavors):
    return [
        ...
        Out("goose-config.yaml", f"# {HEADER}\n# goose's ANSI markdown theme draws with your terminal's colours.\nGOOSE_CLI_THEME: ansi\n",
